...
class MainSceneA5 extends Phaser.Scene {
    constructor() {
        super({ key: 'MainSceneA5' });
        this.player = null;
        this.cursors = null;
        this.monedas = null;
 ...
 this.scale.scaleMode = Phaser.Scale.SHOW_ALL;
  ...
  this.scale.pageAlignVertically = true;
   this.load.image('fondo0', 'tiled/fondo0.png');
   this.load.image('fondo1', 'tiled/fondo1.png');
   this.load.image('fondo2', 'tiled/fondo2.png');
   
   this.load.image('ruta0', 'tiled/ruta0.png');
   this.load.image('ruta1', 'tiled/ruta1.png');
   this.load.image('ruta2', 'tiled/ruta2.png');
 ...
 this.load.spritesheet('vida', 'imag/derbala2.png', {
  ...
  this.load.spritesheet('explosion_zombie', 'Zexp2.png', {
      ...
      this.load.spritesheet('explosion_p', 'imag/explP.png', {
        ...
        this.load.tilemapTiledJSON('mapa0','assets/mapas/mapa1.json');
...
playerInvulnerable = false; 
  ...
  mapa0 = this.make.tilemap({ key: 'mapa0'});
  const fondo0 = mapa0.addTilesetImage('fondo0');
  const fondo1 = mapa0.addTilesetImage('fondo1');
  const fondo2 = mapa0.addTilesetImage('fondo2');
  const ruta0 = mapa0.addTilesetImage('ruta0' );
  const ruta1 = mapa0.addTilesetImage('ruta1' );
  const ruta2 = mapa0.addTilesetImage('ruta2' );
  const layer = mapa0.createLayer("fondo0", fondo0);
  const layer1 = mapa0.createLayer("fondo1", fondo1);
  const layer2 = mapa0.createLayer("fondo2", fondo2);
  const layer5 = mapa0.createLayer("ruta0", ruta0);
  const layer6 = mapa0.createLayer("ruta1", ruta1);
  const layer7 = mapa0.createLayer("ruta2", ruta2);
 
 

 
const mapWidth = mapa0.widthInPixels;
...
this.physics.world.setBounds(0, 0, mapa0.widthInPixels, mapa0.heightInPixels);
...
player.textoSalud = this.add.text(barX, barY - 24, 'Health ' + player.salud, {
  ...
  this.cameras.main.setBounds(0, 0, mapa0.widthInPixels, mapa0.heightInPixels);
...
let pinchos = obstaculos.create(550, 350, 'pinchos');
...
var datosEnemigos = [
  ...
  {x: 3000, y: 300, imagen: 'enemi1'},

 {x: 2100, y: 500, imagen: 'enemi2a'},
 {x: 3400, y: 250, imagen: 'enemi11'},
 {x: 4500, y: 500, imagen: 'enemi5a'},
 {x: 4600, y: 500, imagen: 'enemi12'},
  {x: 4700, y: 300, imagen: 'enemi1a'},
  {x: 4100, y: 300, imagen: 'enemi1'},
...
{x: 4300, y: 500, imagen: 'enemiG'},
  {x: 4700, y: 500, imagen: 'enemiG6'},
  {x: 2500, y: 500, imagen: 'enemiG3'},
  {x: 2700, y: 500, imagen: 'enemiG4'},
  {x: 4000, y: 500, imagen: 'enemiG5'},
  {x: 600, y: 500, imagen: 'enemiG6'},
  ...
  {x: 3300, y: 200, imagen: 'enemiG5'},
 {x: 900, y: 200, imagen: 'enemiG1'},
  {x: 4000, y: 200, imagen: 'enemiG5'},

  
  {x: 4500, y: 500, imagen: 'enemiG'},
  {x: 1900, y: 500, imagen: 'enemiG6'},
  {x: 4600, y: 300, imagen: 'enemiG2'},
...
var datosEnemigosZ1 = [
  ...
  {x: 1450, y: 600, imagen: 'ataque2'},
  {x: 1350, y: 600, imagen: 'ataque2'},
  {x: 1500, y: 600, imagen: 'ataque2'},

  {x: 1950, y: 600, imagen: 'ataque2'},
  {x: 1850, y: 600, imagen: 'ataque2'},
  {x: 1900, y: 600, imagen: 'ataque2'},
  {x: 1950, y: 600, imagen: 'ataque2'},
  {x: 2100, y: 600, imagen: 'ataque2'},

  {x: 2050, y: 600, imagen: 'ataque2'},
  {x: 2150, y: 600, imagen: 'ataque2'},
  {x: 2090, y: 600, imagen: 'ataque2'},
  {x: 2250, y: 600, imagen: 'ataque2'},
  {x: 2390, y: 600, imagen: 'ataque2'},

  {x: 2350, y: 600, imagen: 'ataque2'},
  {x: 3500, y: 600, imagen: 'ataque2'},
  {x: 3600, y: 600, imagen: 'ataque2'},
  {x: 3700, y: 600, imagen: 'ataque2'},
  {x: 3800, y: 600, imagen: 'ataque2'},

  {x: 3900, y: 600, imagen: 'ataque2'},
  {x: 3850, y: 600, imagen: 'ataque2'},
  {x: 3990, y: 600, imagen: 'ataque2'},
  {x: 3650, y: 600, imagen: 'ataque2'},
  {x: 3450, y: 600, imagen: 'ataque2'},

  {x: 3400, y: 600, imagen: 'ataque2'},
  {x: 4250, y: 600, imagen: 'ataque2'},
  {x: 4350, y: 600, imagen: 'ataque2'},
  {x: 4300, y: 600, imagen: 'ataque2'},
  {x: 4450, y: 600, imagen: 'ataque2'},
  {x: 4550, y: 600, imagen: 'ataque2'},
  {x: 4500, y: 600, imagen: 'ataque2'},
...
var datosEnemigosZ2 = [
  ...
  {x: 950, y: 300, imagen: 'ataque3'},
  {x: 970, y: 300, imagen: 'ataque3'},
  {x: 990, y: 300, imagen: 'ataque3'},
  {x: 950, y: 200, imagen: 'ataque3'},
  {x: 970, y: 200, imagen: 'ataque3'},

  {x: 990, y: 300, imagen: 'ataque3'},
  {x: 2350, y: 200, imagen: 'ataque3'},
  {x: 2400, y: 200, imagen: 'ataque3'},
  {x: 2450, y: 200, imagen: 'ataque3'},
  {x: 3400, y: 200, imagen: 'ataque3'},

  {x: 3350, y: 200, imagen: 'ataque3'},
  {x: 4350, y: 200, imagen: 'ataque3'},
  {x: 3400, y: 200, imagen: 'ataque3'},
  {x: 4600, y: 200, imagen: 'ataque3'},
...
totalEnemigos = enemigoss.countActive(true) + enemigos.countActive(true) + enemigosA.countActive(true) + enemigoZ1.countActive(true) + enemigoZ2.countActive(true); 
...
const impactos = (player, enemy0) => {
 ...
 // this.sound.play('explosionSound');
  ...
  this.time.delayedCall(900, () => {
    this.scene.start('GameOverScene', { lostSceneKey: 'MainSceneA5' });
  });
}
...
const objetoColision = mapa0.getObjectLayer('objetoColecciónX');
...
const objetoColisione = mapa0.getObjectLayer('objetoColision');
...
// Oculta el botón si el juego NO se está ejecutando en un dispositivo móvil
if (this.sys.game.device.os.desktop) {
...
function crearPisoDeRebote(scene, objetosRebotables, opciones = {}) {
  ...
  const anchoMapa = mapa0?.widthInPixels || this.scale.width;
...
checkEnemigos() {
    ...
    const gruposDeEnemigos = [enemigos, enemigoss, enemigosA, enemigoZ1, enemigoZ2];
        ...
        if (grupo) { // Asegúrate de que el grupo existe
            grupo.children.iterate(enemigo => {
                if (enemigo) { // Asegúrate de que el enemigo existe
                    ...
                    if (enemigo.x < 0 || enemigo.x > mapa0.widthInPixels || enemigo.y < 0 || enemigo.y > mapa0.heightInPixels) {
...
const jumpSpeed = -850; // Ascenso más explosivo
...
updateEnemies() {
  ...
  var velocidadEnemigo2 = 120;
  var distanciaDeteccion = 1200; // Distancia a la que el enemigo detecta al jugador
