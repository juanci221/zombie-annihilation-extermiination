...
class MainSceneA4 extends Phaser.Scene {
    constructor() {
        super({ key: 'MainSceneA4' });
        this.player = null;
        this.cursors = null;
        this.monedas = null;
 ...
 this.scale.scaleMode = Phaser.Scale.SHOW_ALL;
  ...
  this.scale.pageAlignVertically = true;
   this.load.image('N40', 'tiled/N40.png');
   this.load.image('N41', 'tiled/N41.png');
   this.load.image('N42', 'tiled/N42.png');
   this.load.image('N43', 'tiled/N43.png');
 ...
 this.load.spritesheet('vida', 'imag/derbala2.png', {
  ...
  this.load.spritesheet('explosion_p', 'imag/explP.png', {
    ...
    this.load.tilemapTiledJSON('mapa2','assets/mapas/mapaN4.json');
   
this.load.spritesheet('dude', 'imag/playerC231.png', { frameWidth: 120, frameHeight: 130 });
 this.load.spritesheet('E', 'imag/ZNu1.png', { frameWidth: 200, frameHeight: 200 });
 
    this.load.spritesheet('ataque3', 'imag/S33.png', { frameWidth: 120, frameHeight: 100 });
    this.load.spritesheet('ataque2', 'imag/ataque.png', { frameWidth: 100, frameHeight: 100 });
  ...
  // this.load.spritesheet('E', 'imag/players2.png', { frameWidth: 125, frameHeight: 150 });
   this.load.spritesheet('A', 'imag/ataque4.png', { frameWidth: 130, frameHeight: 130 });
...
playerInvulnerable = false; 
  ...
  const N40 = mapa2.addTilesetImage('N40');
  const N41 = mapa2.addTilesetImage('N41');
  const N42 = mapa2.addTilesetImage('N42');
  const N43 = mapa2.addTilesetImage('N43');
  const layer = mapa2.createLayer("N40", N40);
  const layer1 = mapa2.createLayer("N41", N41);
  const layer2 = mapa2.createLayer("N42", N42);
  const layer3 = mapa2.createLayer("N43", N43);
...
const mapWidth = mapa2.widthInPixels;
...
this.physics.world.setBounds(0, 0, mapa2.widthInPixels, mapa2.heightInPixels);
...
if (!this.anims.exists('enemy2_left')) {
    this.anims.create({
      key: 'enemy2_left',
      frames: this.anims.generateFrameNumbers('E', { start: 0, end: 4 }),
...
if (!this.anims.exists('enemy2_right')) {
    this.anims.create({
      key: 'enemy2_right',
      frames: this.anims.generateFrameNumbers('E', { start: 5, end: 9 }),
      frameRate: 10, // ⬅️ Aumentado para un movimiento más rápido
      repeat: -1
    });
}
...
if (!this.anims.exists('enemy2_up')) {
    this.anims.create({
      key: 'enemy2_up', 
      frames: this.anims.generateFrameNumbers('E', { start: 0, end: 9 }), 
      frameRate: 10, 
      repeat: -1 
    });
}
...
var datosEnemigos = [
  ...
  {x: 1500, y: 300, imagen: 'enemi2a'},
  {x: 1700, y: 500, imagen: 'enemi3'},
  {x: 2500, y: 300, imagen: 'enemi5'},
  {x: 5600, y: 300, imagen: 'enemi12'}, 
  {x: 5700, y: 300, imagen: 'enemi3a'}, 
  {x: 3800, y: 500, imagen: 'enemi8'},
  {x: 3900, y: 500, imagen: 'enemi9'},
  {x: 4000, y: 500, imagen: 'enemi10'},
  {x: 4900, y: 500, imagen: 'enemi9'},
 ...
 {x: 5400, y: 250, imagen: 'enemi11'},
 {x: 5500, y: 600, imagen: 'enemi5a'},
 {x: 5700, y: 500, imagen: 'enemi10'},
...
var datosEnemigoA = [
  ...
  {x: 5600, y: 600, imagen: 'enemiG'},
  {x: 4900, y: 600, imagen: 'enemiG6'},
  {x: 2500, y: 500, imagen: 'enemiG3'},
  {x: 2700, y: 500, imagen: 'enemiG4'},
  {x: 4000, y: 600, imagen: 'enemiG5'},
  {x: 5600, y: 600, imagen: 'enemiG6'},
  {x: 2900, y: 500, imagen: 'enemiG1'},
  {x: 2000, y: 300, imagen: 'enemiG2'},
  {x: 3000, y: 500, imagen: 'enemiG5'},
  {x: 1200, y: 200, imagen: 'enemiG6'},

  {x: 900, y: 200, imagen: 'enemiG1'},
  {x: 5100, y: 600, imagen: 'enemiG5'},
  {x: 5300, y: 200, imagen: 'enemiG1'},


  
  {x: 4600, y: 600, imagen: 'enemiG'},
  {x: 1900, y: 500, imagen: 'enemiG6'},
  {x: 5000, y: 600, imagen: 'enemiG2'},
  {x: 4500, y: 600, imagen: 'enemiG3'},
  {x: 3700, y: 500, imagen: 'enemiG4'},
...
var datosEnemigosZ1 = [
  ...
  {x: 1200, y: 600, imagen: 'ataque2'},
  {x: 1300, y: 600, imagen: 'ataque2'},
  {x: 3450, y: 600, imagen: 'ataque2'},
  {x: 3350, y: 600, imagen: 'ataque2'},
  {x: 3500, y: 600, imagen: 'ataque2'},
  {x: 950, y: 600, imagen: 'ataque2'},
  {x: 850, y: 600, imagen: 'ataque2'},
  {x: 900, y: 600, imagen: 'ataque2'},

  
  {x: 700, y: 600, imagen: 'ataque2'},
  {x: 5600, y: 600, imagen: 'ataque2'},
  {x: 650, y: 600, imagen: 'ataque2'},
  {x: 750, y: 600, imagen: 'ataque2'},
  {x: 800, y: 600, imagen: 'ataque2'},
  {x: 3800, y: 600, imagen: 'ataque2'},
  {x: 5950, y: 600, imagen: 'ataque2'},
  {x: 5850, y: 600, imagen: 'ataque2'},
  {x: 5900, y: 600, imagen: 'ataque2'},
  {x: 4800, y: 600, imagen: 'ataque2'},
...
var datosEnemigosZ2 = [
  ...
  {x: 1950, y: 200, imagen: 'ataque3'},
  {x: 1970, y: 200, imagen: 'ataque3'},
  {x: 1990, y: 200, imagen: 'ataque3'},
  {x: 1950, y: 200, imagen: 'ataque3'},
  {x: 1970, y: 200, imagen: 'ataque3'},
  {x: 1990, y: 200, imagen: 'ataque3'},
  {x: 2350, y: 200, imagen: 'ataque3'},
  {x: 1800, y: 200, imagen: 'ataque3'},
  {x: 5450, y: 200, imagen: 'ataque3'},
  {x: 5400, y: 200, imagen: 'ataque3'},
  {x: 5350, y: 200, imagen: 'ataque3'},
  {x: 5650, y: 200, imagen: 'ataque3'},
  {x: 5700, y: 200, imagen: 'ataque3'},
  {x: 2600, y: 200, imagen: 'ataque3'},
 {x: 3200, y: 200, imagen: 'ataque3'},
 {x: 3300, y: 200, imagen: 'ataque3'},
  {x: 3100, y: 200, imagen: 'ataque3'},
 {x: 3400, y: 200, imagen: 'ataque3'},
];
...
spatEnemy = this.physics.add.sprite(5600, 600, 'E');
spatEnemy.setScale(1.2);
spatEnemy.salud = 1500;
spatEnemy.impactos = 0;
spatEnemy.damage = 5;
spatEnemy.salto = true;
spatEnemy.lastAttackTime = 0;
spatEnemy.attackCooldown = 2000;
spatEnemy.isAttacking = false;
spatEnemy.estado = 'idle';
totalEnemigos++;



crearPisoDeRebote(this, [player, enemigos, enemigoss, enemigosA, spatEnemy], {
  y: 770,
  altura: 100,
  color: 0x00ff00,
  fuerzaRebote: -600,
...
this.bossOverlap = this.physics.add.overlap(balaHielo, spatEnemy, this.handleBulletBossCollision, null, this);
...
this.ataqueEnemigoProyectil = (player, enemigo) => {
 ...
 // this.sound.play('explosionSound');
  ...
  this.time.delayedCall(900, () => {
    this.scene.start('GameOverScene', { lostSceneKey: 'MainSceneA4' });
  });
}
...
this.physics.add.collider(player, spatEnemy, impactos, null, this);
...
this.physics.add.overlap(player, spatEnemy, impactos, null, this);


  const objetoColision = mapa2.getObjectLayer('objetoColisionO');
 ...
 const objetoColisione = mapa2.getObjectLayer('objetoColisionE');
      ...
      objetoColisione.objects.forEach(function (obj) {
        ...
        this.physics.add.collider(spatEnemy,  objetoSprites, function() {
...
function crearPisoDeRebote(scene, objetosRebotables, opciones = {}) {
  ...
  const anchoMapa = mapa2?.widthInPixels || this.scale.width;
        ...
        if (grupo) { // Asegúrate de que el grupo existe
            grupo.children.iterate(enemigo => {
                if (enemigo) { // Asegúrate de que el enemigo existe
                    ...
                    if (enemigo.x < 0 || enemigo.x > mapa2.widthInPixels || enemigo.y < 0 || enemigo.y > mapa2.heightInPixels) {
...
this.checkCoinsCollected();
  ...
  this.updatePlayerHealthBar();
   ...
   enemigoZ.getChildren().forEach((enemigo10, index) => { //  AGREGAR 'index'
        if (spatEnemy && enemigo10.active && !enemigo10.isThrown) { 
            // Pasar el 'index' a updateEnemyLogic
            this.updateEnemyLogic(enemigo10, spatEnemy, index); 
        }
    });
...
checkCoinsCollected() {
    ...
    // El spatEnemy se considera derrotado si la variable es null o undefined.
    // Asumimos que al morir, se debe establecer a null (ver punto 2).
    const isSpatEnemyDefeated = (spatEnemy === null || typeof spatEnemy === 'undefined');

    // La escena inicia SÓLO si no quedan enemigos normales Y el spatEnemy está derrotado.
...
if (spatEnemy && spatEnemy.active && spatEnemy.body && spatEnemy.visible) {
  const distance = Phaser.Math.Distance.Between(player.x, player.y, spatEnemy.x, spatEnemy.y);
  const CHASE_RANGE = 800;
  const ATTACK_RANGE = 500;
  const currentTime = this.time.now;

  if (distance < CHASE_RANGE) {
    if (distance < ATTACK_RANGE && !spatEnemy.isAttacking && currentTime > spatEnemy.lastAttackTime + spatEnemy.attackCooldown) {
      spatEnemy.body.setVelocityX(0);
      spatEnemy.lastAttackTime = currentTime;
      spatEnemy.isAttacking = true;
      spatEnemy.estado = 'atacando';
      ...
      if (zombieProyectil) {
        ...
        zombieProyectil.setPosition(spatEnemy.x, spatEnemy.y);
        ...
        this.time.delayedCall(500, () => {
       if (spatEnemy && spatEnemy.active && spatEnemy.body && typeof spatEnemy.setFrame === 'function') {
  spatEnemy.isAttacking = false;
  spatEnemy.estado = 'idle';
  spatEnemy.setFrame(5);
}

        });
      }
    } else if (!spatEnemy.isAttacking) {
      const direccion = player.x < spatEnemy.x ? -1 : 1;
      spatEnemy.body.setVelocityX(direccion * 120);
      spatEnemy.estado = 'corriendo';
      spatEnemy.anims.play(direccion === -1 ? 'enemy2_left' : 'enemy2_right', true);

     const distanciaX = Math.abs(player.x - spatEnemy.x);

// Salta si el jugador está cerca, está en el suelo y puede saltar
if (distanciaX < 200 && spatEnemy.body.blocked.down && spatEnemy.salto) {
  spatEnemy.body.setVelocityY(-400);
  if (spatEnemy.anims.currentAnim?.key !== 'enemy2_up') {
    spatEnemy.anims.play('enemy2_up', true);
  }
  spatEnemy.salto = false;
}

// Vuelve a habilitar el salto cuando toca el suelo
if (spatEnemy.body.blocked.down) {
  spatEnemy.salto = true;
}
 ...
 updateEnemyLogic(enemigo10, spatEnemy, index) { 
    
    // Calcula la distancia entre el jefe y el seguidor
    const distance = Phaser.Math.Distance.Between(spatEnemy.x, spatEnemy.y, enemigo10.x, enemigo10.y);
    ...
    if (distance < chaseDistance) {
        ...
        this.chase(enemigo10, spatEnemy, index, targetRadius); 
...
chase(enemigo10, spatEnemy, index, targetRadius) {
    if (!spatEnemy) return; //  Correcto: Seguridad contra errores de null
    ...
    const targetX = spatEnemy.x + targetRadius * Math.cos(angle);
    const targetY = spatEnemy.y + targetRadius * Math.sin(angle);
