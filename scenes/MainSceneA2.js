...
class MainSceneA2 extends Phaser.Scene {
    constructor() {
        super({ key: 'MainSceneA2' });
        this.player = null;
        this.cursors = null;
        this.monedas = null;
 ...
 init(data) {
  ...
  this.scale.pageAlignVertically = true;
   // Carga tus imágenes
   this.load.image('FN0', 'tiled/FN0.png');
   this.load.image('FN2', 'tiled/FN2.png');
   this.load.image('FN1', 'tiled/FN1.png');
   this.load.image('FN3', 'tiled/FN3.png');
   
   
   
   this.load.image('moneda', 'imag/derbala1.png');
    
   this.load.image('llenado1', 'imag/T16.png');
 ...
 this.load.spritesheet('vida', 'imag/derbala2.png', {
  ...
  this.load.spritesheet('explosion_zombie', 'Zexp2.png', {
   ...
   this.load.tilemapTiledJSON('mapa','assets/mapas/mapaN2.json');
...
playerInvulnerable = false; 
  ...
  const fondoA = mapa.addTilesetImage('FN0');
  const fondoB = mapa.addTilesetImage('FN2');
  const fondoC = mapa.addTilesetImage('FN1');
  const fondoD = mapa.addTilesetImage('FN3');
 
  const layer = mapa.createLayer("FN0", fondoA);
  const layer1 = mapa.createLayer("FN2", fondoB);
  const layer2 = mapa.createLayer("FN1", fondoC);
  const layer3 = mapa.createLayer("FN3", fondoD);
...
animacionGas.setAlpha(0.9); 
 ...
 // enemigos 1
  var datosEnemigo2 = [
    {x: 3000, y: 500, imagen: 'enemi6a'},
    {x: 3900, y: 500, imagen: 'enemi6b'},
    {x: 4500, y: 500, imagen: 'enemi6a'},
...
var datosEnemigos = [
  ...
  {x: 1900, y: 500, imagen: 'enemi1'},
  {x: 2900, y: 500, imagen: 'enemi1a'},
  {x: 2500, y: 300, imagen: 'enemi2a'},
  {x: 700, y: 500, imagen: 'enemi3'},
  {x: 2500, y: 300, imagen: 'enemi5'},
  {x: 2500, y: 300, imagen: 'enemi12'}, 
  {x: 3900, y: 300, imagen: 'enemi3a'}, 
  {x: 5000, y: 500, imagen: 'enemi8'},
  {x: 2600, y: 500, imagen: 'enemi9'},
...
var datosEnemigoA = [
  ...
  {x: 1600, y: 500, imagen: 'enemiG'},
  {x: 4900, y: 500, imagen: 'enemiG6'},
  {x: 1500, y: 500, imagen: 'enemiG3'},
  {x: 2700, y: 500, imagen: 'enemiG4'},
  {x: 4000, y: 500, imagen: 'enemiG5'},
  {x: 3600, y: 500, imagen: 'enemiG6'},
  {x: 3900, y: 500, imagen: 'enemiG1'},
  {x: 2000, y: 300, imagen: 'enemiG2'},
  {x: 3000, y: 500, imagen: 'enemiG5'},
  {x: 4200, y: 200, imagen: 'enemiG6'},

  {x: 5500, y: 200, imagen: 'enemiG1'},
  {x: 2000, y: 200, imagen: 'enemiG5'},


  
  {x: 4600, y: 500, imagen: 'enemiG'},
  {x: 2900, y: 500, imagen: 'enemiG6'},
...
var datosEnemigosZ2 = [
 ...
 {x: 950, y: 200, imagen: 'ataque3'},
  ...
  {x: 970, y: 200, imagen: 'ataque3'},
  {x: 990, y: 200, imagen: 'ataque3'},
  {x: 5350, y: 500, imagen: 'ataque3'},
  {x: 3400, y: 200, imagen: 'ataque3'},
  {x: 3450, y: 200, imagen: 'ataque3'},
  {x: 5400, y: 200, imagen: 'ataque3'},
  {x: 5350, y: 200, imagen: 'ataque3'},
  {x: 5350, y: 200, imagen: 'ataque3'},
  {x: 5400, y: 200, imagen: 'ataque3'},
  {x: 5600, y: 200, imagen: 'ataque3'},
...
totalEnemigos =  enemigoss.countActive(true) + enemigos.countActive(true) + enemigosA.countActive(true) + enemigoZ2.countActive(true); 
...
const impactos = (player, enemy0) => {
 ...
 // this.sound.play('explosionSound');
  ...
  this.time.delayedCall(900, () => {
    this.scene.start('GameOverScene', { lostSceneKey: 'MainSceneA2' });
  });
}
...
this.physics.add.overlap(player, enemigoZ2, impactos, null, this);
  ...
  const objetoColision = mapa.getObjectLayer('ObjetoColisionA');
  ...
  this.physics.add.collider(obstaculos, objetoSprite, function() {
      ...
      const objetoColisione = mapa.getObjectLayer('ObjetoColisionB');
...
function crearPisoDeRebote(scene, objetosRebotables, opciones = {}) {
  ...
  const anchoMapa = mapa?.widthInPixels || this.scale.width;
...
checkEnemigos() {
    ...
    const gruposDeEnemigos = [enemigos, enemigoss, enemigosA, enemigoZ2];
        ...
        if (grupo) { // Asegúrate de que el grupo existe
            grupo.children.iterate(enemigo => {
                if (enemigo) { // Asegúrate de que el enemigo existe
                    ...
                    if (enemigo.x < 0 || enemigo.x > mapa.widthInPixels || enemigo.y < 0 || enemigo.y > mapa.heightInPixels) {
...
checkCoinsCollected() {
    ...
    if (totalEnemigos === 0) {
        ...
        this.scene.start('EndScene', {
            ...
            currentLevelIndex: 1,
            levelTitle: 'Nivel 2' // Nombre del nivel actual
        });
    }
}
