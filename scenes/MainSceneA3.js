...
class MainSceneA3 extends Phaser.Scene {
    constructor() {
        super({ key: 'MainSceneA3' });
        this.player = null;
        this.cursors = null;
        this.monedas = null;
 ...
 init(data) {
  ...
  this.scale.pageAlignVertically = true;
   ...
   this.load.image('N30', 'tiled/N30.png');
   this.load.image('N31', 'tiled/N31.png');
   this.load.image('N32', 'tiled/N32.png');
   this.load.image('N33', 'tiled/N33.png');
   ...
   this.load.image('pinchos', 'imag/T12.png'); 
   this.load.image('llenado3', 'imag/T16.png');
    this.load.image('llenado4', 'imag/T13.png');
 ...
 this.load.spritesheet('vida', 'imag/derbala2.png', {
  ...
  this.load.spritesheet('explosion_p', 'imag/explP.png', {
   ...
   this.load.tilemapTiledJSON('mapa3','assets/mapas/mapaN3.json');
...
playerInvulnerable = false; 
  ...
  that = this; // Almacena 'this' en 'that'
   mapa3 = this.make.tilemap({ key: 'mapa3'});
   const N30 = mapa3.addTilesetImage('N30');
   const N31 = mapa3.addTilesetImage('N31');
   const N32 = mapa3.addTilesetImage('N32');
   const N33 = mapa3.addTilesetImage('N33');

   const layer = mapa3.createLayer("N30", N30);
   const layer1 = mapa3.createLayer("N31", N31);
   const layer2 = mapa3.createLayer("N32", N32);
   const layer3 = mapa3.createLayer("N33", N33);
  
 


const mapWidth = mapa3.widthInPixels;
...
this.sound.stopAll(); // Detiene todos los sonidos, incluida la música de fondo
  ...
  const musicaDeFondoA = this.sound.add('f', { volume: 0.5, loop: true });
    musicaDeFondoA.play();
...
this.physics.world.setBounds(0, 0, mapa3.widthInPixels, mapa3.heightInPixels);
...
player.textoSalud = this.add.text(barX, barY - 24, 'Health ' + player.salud, {
  ...
  this.cameras.main.setBounds(0, 0, mapa3.widthInPixels, mapa3.heightInPixels);
...
key: 'pinchos',
repeat:6,
setXY :{ x:1220, y: 600, stepX: 500}

   }); // O un grupo normal si quieres que se muevan

// Añade un obstáculo en una posición específica
let pinchos = obstaculos.create(3600, 600, 'pinchos');
...
var datosEnemigos = [
  ...
  {x: 1500, y: 300, imagen: 'enemi1'},
  {x: 4900, y: 500, imagen: 'enemi1a'},
  {x: 2500, y: 300, imagen: 'enemi2a'},
  {x: 800, y: 300, imagen: 'enemi3'},
  {x: 500, y: 600, imagen: 'enemi5'},
  {x: 990, y: 600, imagen: 'enemi12'}, 
  {x: 700, y: 600, imagen: 'enemi3a'}, 
  {x: 1200, y: 300, imagen: 'enemi8'},
  {x: 4000, y: 500, imagen: 'enemi10'},

  
  {x: 3500, y: 500, imagen: 'enemi4a'},
  {x: 4600, y: 500, imagen: 'enemi12'},
  {x: 1700, y: 300, imagen: 'enemi1a'},
  {x: 5000, y: 300, imagen: 'enemi9'},

 {x: 5100, y: 500, imagen: 'enemi2a'},
 {x: 5400, y: 250, imagen: 'enemi11'},
 {x: 5500, y: 600, imagen: 'enemi5a'},

 {x: 2900, y: 500, imagen: 'enemi1'},
  {x: 1900, y: 300, imagen: 'enemi1a'},
 
  {x: 3000, y: 500, imagen: 'enemi3'},
...
var datosEnemigoA = [
  ...
  {x: 4700, y: 500, imagen: 'enemiG4'},
  {x: 4000, y: 500, imagen: 'enemiG5'},
  {x: 3600, y: 500, imagen: 'enemiG6'},
  {x: 4900, y: 100, imagen: 'enemiG1'},
  {x: 2400, y: 300, imagen: 'enemiG2'},
  {x: 3000, y: 500, imagen: 'enemiG5'},
  {x: 3200, y: 300, imagen: 'enemiG6'},

  {x: 4500, y: 300, imagen: 'enemiG1'},
  {x: 3000, y: 300, imagen: 'enemiG6'},


  
 
  {x: 5900, y: 300, imagen: 'enemiG3'},
  {x: 4000, y: 300, imagen: 'enemiG2'},
  {x: 4500, y: 300, imagen: 'enemiG3'},
  {x: 3700, y: 500, imagen: 'enemiG4'},
 
  
  {x: 4500, y: 500, imagen: 'enemiG3'},
  {x: 3700, y: 500, imagen: 'enemiG4'},
  {x: 5400, y: 500, imagen: 'enemiG5'},

  
  {x: 5400, y: 500, imagen: 'enemiG6'},
  {x: 5500, y: 500, imagen: 'enemiG5'},
  {x: 5300, y: 500, imagen: 'enemiG1'},
  {x: 5500, y: 500, imagen: 'enemiG2'},
  {x: 5800, y: 600, imagen: 'enemiG3'},
  {x: 5900, y: 600, imagen: 'enemiG4'},
];
...
var datosEnemigosZ1 = [
  ...
  {x: 1800, y: 600, imagen: 'ataque2'},
  {x: 1750, y: 600, imagen: 'ataque2'},
  {x: 1350, y: 600, imagen: 'ataque2'},
  {x: 1400, y: 600, imagen: 'ataque2'},
  {x: 1450, y: 600, imagen: 'ataque2'},
  {x: 1400, y: 600, imagen: 'ataque2'},
  {x: 1350, y: 600, imagen: 'ataque2'},
  {x: 2350, y: 600, imagen: 'ataque2'},
  {x: 2400, y: 600, imagen: 'ataque2'},
  {x: 2600, y: 600, imagen: 'ataque2'},
 ...
 {x: 4000, y: 600, imagen: 'ataque2'},
  ...
  {x: 4400, y: 600, imagen: 'ataque2'},
  {x: 4500, y: 600, imagen: 'ataque2'},
  {x: 5400, y: 600, imagen: 'ataque2'},
  {x: 5600, y: 600, imagen: 'ataque2'},
  {x: 5700, y: 600, imagen: 'ataque2'},
  {x: 5800, y: 600, imagen: 'ataque2'},
...
for (var i = 0; i < datosEnemigosZ1.length; i++) {
  ...
  enemigo100.salud = 120; // Asigna la salud al enemigo
  enemigo100.speed = 120; // Velocidad de movimiento
...
totalEnemigos =  enemigoss.countActive(true) + enemigos.countActive(true) + enemigosA.countActive(true) + enemigoZ1.countActive(true); 
 ...
 // condiciones enemigo 2
  ...
  enemigosA.children.iterate(function (enemigoX) {
     ...
     if (enemigoX.texture.key === 'enemiG') {
      ...
      }else  if (enemigoX.texture.key === 'enemiG7') {
       enemigoX.anims.play('enemigoG7_right_walk', false); 
      enemigoX.anims.play('enemigoG7_left_walk', true);
      }else  if (enemigoX.texture.key === 'enemiG8') {
       enemigoX.anims.play('enemigoG8_right_walk', false); 
      enemigoX.anims.play('enemigoG8_left_walk', true);
      }
...
if (player.salud <= 0) {
 ...
 // this.sound.play('explosionSound');
  ...
  this.time.delayedCall(900, () => {
    this.scene.start('GameOverScene', { lostSceneKey: 'MainSceneA3' });
  });
}
...
this.physics.add.overlap(player, enemigoZ1, impactos, null, this);
  ...
  const objetoColision = mapa3.getObjectLayer('objetoColisionC');
  ...
  this.physics.add.collider(obstaculos, objetoSprite, function() {
      ...
      const objetoColisione = mapa3.getObjectLayer('objetoColisionD');
...
buttonShoot.on('pointerdown', () => {
 ...
 function crearPisoDeRebote(scene, objetosRebotables, opciones = {}) {
  ...
  const anchoMapa = mapa3?.widthInPixels || this.scale.width;
...
checkEnemigos() {
    ...
    const gruposDeEnemigos = [enemigoZ1,enemigos, enemigoss, enemigosA];
        ...
        if (grupo) { // Asegúrate de que el grupo existe
            grupo.children.iterate(enemigo => {
                if (enemigo) { // Asegúrate de que el enemigo existe
                    ...
                    if (enemigo.x < 0 || enemigo.x > mapa3.widthInPixels || enemigo.y < 0 || enemigo.y > mapa3.heightInPixels) {
...
checkCoinsCollected() {
    ...
    if (totalEnemigos === 0) {
        ...
        this.scene.start('EndScene', {
            ...
            currentLevelIndex: 2,
            levelTitle: 'Nivel 3' // Nombre del nivel actual
        });
    }
}
      ...
      if (enemX && enemX.body) {
        ...
        if (distancia < distanciaDeteccion) {
          ...
          if (player.x > enemX.x) {
            ...
            }  else if (enemX.texture.key === 'enemiG7') {
              enemX.anims.play('enemigoG7_right_walk', true);
            }  else if (enemX.texture.key === 'enemiG8') {
              enemX.anims.play('enemigoG8_right_walk', true);
            } 
            ...
            if (enemX.texture.key === 'enemiG') {
              ...
              enemX.anims.play('enemigoG7_left_walk', true);
            }else if (enemX.texture.key === 'enemiG8') {
              enemX.anims.play('enemigoG8_left_walk', true);
            }
          }
        }
      }
...
enemigosA.children.iterate(function (enemX) {
   ...
   var startY1 = enemD.y + enemD.height / 2 - 20;
                ...
                var damageTexto = this.add.text(enemD.x, startY1, '....', { alpha: 0.5, fontSize: '20px', fill: '#e1e7e2ff' });
                 damageTexto.setOrigin(0.5);
                // Añade la animación Tween para hacerlo flotar y desaparecer
                this.tweens.add({
                    targets: damageTexto,
